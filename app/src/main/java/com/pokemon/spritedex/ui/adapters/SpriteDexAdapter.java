package com.pokemon.spritedex.ui.adapters;
...
import com.pokemon.spritedex.model.pojo.util.Download;
import com.pokemon.spritedex.model.pojo.util.Ordem;
import com.pokemon.spritedex.ui.activities.DetailActivity;
...
public class SpriteDexAdapter extends RecyclerView.Adapter<SpriteDexAdapter.ViewHolder> {
    private Context context;
    private int lastIndexClick = 0;
    private View.OnClickListener listener;
    public List<Pokemon> pokemons;

    public SpriteDexAdapter(Context context) {
        this.context = context;
        this.pokemons = new ArrayList<>();
    }

    public SpriteDexAdapter(Context context, List<Pokemon> pokemons) {
        this.context = context;
        this.pokemons = pokemons;
    }

    public SpriteDexAdapter(Context context, View.OnClickListener listener) {
        this.context = context;
        this.pokemons = new ArrayList<>();
        this.listener = listener;
    }

    public SpriteDexAdapter(Context context, List<Pokemon> pokemons, View.OnClickListener listener) {
        this.context = context;
        this.pokemons = pokemons;
        this.listener = listener;
    }
